...
const namabot = "Varvatos MD" // Ganti Nama Bot Kalian
const nameown = "Varvatos MY" // Ganti Nama Kalian
const numown = "60122222247" // Ganti Nomor Kalian
const nameowner = "Varvatos" // Ganti Nama Kalian
const footer = "Varvatos MD 2022" // Ganti Nama Bot Kalian
const capt = "*By varvatos Bot MD*" // Ganti Nama Bot Kalian
const grup = "https://chat.whatsapp.com/" // Ganti Link Group Kalian
const nomorown = "https://wa.me/60122222247" // Ganti Nomor Kalian
const note = "*_Bot Ini Masih Dalam Pengembangan Jika Ada Fitur Yang Eror Silakan Hubungi Owner!!!_*" // Kalau Mau Ganti Aja
const namagrup = "Group Varvatos MD" // Ubah Nama Group Mu

// Setting Donasi
const gopay = "60122222247" // Ganti Nomor Gopay Mu
const pulsa = "60122222247" // Ganti No Pulsa Mu
const insta = "xxgaius" // Ganti Nama IG Mu
const github = "xigosu" // Ganti Nama Github Mu
...
case prefix+'donasi':
  case prefix+'donate':
  var donasibut = [
			{ urlButton: { displayText: `Group varvatos Bot`, url : `${grup}` } },
...
⚠️ Segala kebijakan dan kketentuan varvatos Bot di pegang oleh owner dan segala perubahan kebijakan, sewaktu waktu owner berhak mencabut, memblokir user(*﹏*)

Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan varvatos Bot
😖🙏`
...
case prefix+'infobot':
  case prefix+'inforobot':
    case prefix+'info':
      var caption = `*[ INFO Varvatos BOT ]*

*Nama Bot :* varvatos - MD
*Name Owner :* Varvatos MY
...
case prefix+'githubown':
 ...
 break
			...
			{ quickReplyButton: { displayText: `Ubah Ke Audio`, id: `${prefix}tiktokaudio ${q}` } },
				...
				reply(mess.wait)
				conn.sendMessage(from, { caption: `Succes Download Video Tiktok, Thanks For Using Varvatos-Bot!`, video: {url: data.nowm}, templateButtons: tidtod, footer: `${footer}`, mentions: [sender]} )
			}).catch(() => reply(mess.error.api))
			limitAdd(sender, limit)
			    break
